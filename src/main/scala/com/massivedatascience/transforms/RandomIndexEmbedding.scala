...
/** Embeds vectors in high dimensional spaces into dense vectors of low dimensional space in a way that preserves
  ...
  *
  * @param outputDim
  *   number of dimensions to use for the dense vector
  * @param epsilon
  *   portion of dimensions with non-zero values
  */
...
/** A simple <a href="http://en.wikipedia.org/wiki/Hash_function">multiplicative hash function</a> that supports mapping
  ...
  *   additive seed
  * @param l
  *   log of the number of dimensions of the input
  * @param m
  *   log of the number of dimensions of the output
  */
