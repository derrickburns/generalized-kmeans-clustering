...
object XORShiftRandom {
  ...
  /** Global random instance for generating default seeds.
    *
    * NOTE: This is intentionally NOT seeded to provide different default behavior across JVM
    * restarts. Users requiring deterministic behavior should always pass an explicit seed parameter
