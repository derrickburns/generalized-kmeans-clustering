...
trait GeneralizedKMeansParams
  ...
  /** Number of clusters to create (k). Must be > 1. Default: 2
    */
  ...
  /** Assignment strategy: "broadcast", "crossJoin", or "auto".
    ...
    *   - auto: Automatically select based on kernel Default: "auto"
    */
  ...
  /** Empty cluster handling strategy: "reseedRandom" or "drop".
    ...
    *   - drop: Drop empty clusters (return fewer than k) Default: "reseedRandom"
    */
  ...
  /** Checkpoint directory. If not set, uses Spark's default. Default: None
    */
  ...
  /** Initialization mode: "random" or "k-means||".
    ...
    *   - k-means||: K-means|| parallel initialization Default: "k-means||"
    */
