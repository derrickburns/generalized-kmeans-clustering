...
import com.massivedatascience.clusterer.coreset.{
  BregmanCoreset,
  BregmanSensitivity,
  CoresetConfig,
  CoresetResult,
...
/** Configuration for core-set based K-means clustering.
  *
  * @param coresetConfig
  *   Configuration for core-set construction
  * @param maxIterations
  *   Maximum iterations for clustering on core-set
  * @param refinementIterations
  *   Number of refinement iterations on full data
  * @param convergenceThreshold
  *   Convergence threshold for core-set clustering
...
/** Result of core-set based clustering with detailed metrics.
  ...
  * @param distortion
  *   Final clustering distortion
  * @param coresetResult
  *   Result from core-set construction
  * @param coresetIterations
  *   Number of iterations used on core-set
  * @param refinementIterations
  *   Number of refinement iterations used
  * @param totalTime
  *   Total clustering time in milliseconds
  * @param config
  *   Configuration used
  */
...
case class CoresetKMeans(config: CoresetKMeansConfig = CoresetKMeans.defaultConfig)
  ...
  def cluster(
    ...
    logger.info(
      s"Core-set built: ${coresetResult.coreset.length} points " +
