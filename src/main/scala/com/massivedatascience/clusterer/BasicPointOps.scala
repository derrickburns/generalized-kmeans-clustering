...
case class BasicPointOps(
  ...
  def embed(v: WeightedVector): WeightedVector = embedding.embed(v)
  ...
  def vectorToPoint(v: WeightedVector): BregmanPoint = {
    val embedded = embed(v)
    BregmanPoint(embedded, divergence.F(embedded.homogeneous, embedded.weight))
  }
...
class DelegatedPointOps(ops: BregmanPointOps, embedding: Embedding) extends BregmanPointOps  {
  ...
  def embed(v: WeightedVector): WeightedVector = ops.embed(embedding.embed(v))
  ...
  def vectorToPoint(v: WeightedVector) = ops.vectorToPoint(v)
...
object DiscreteDenseSmoothedKLPointOps extends BasicPointOps(NaturalKLDivergence) {
  ...
  override def vectorToPoint(v: WeightedVector): BregmanPoint = {
    BregmanPoint(v, divergence.F(v.homogeneous, v.weight))
  }
...
object GeneralizedSymmetrizedKLPointOps extends BasicPointOps(RealKLDivergence) {
  override def embed(v: WeightedVector): WeightedVector = {
