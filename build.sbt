...
ScoverageSbtPlugin.ScoverageKeys.coverageExcludedPackages := ".*.clusterer.CachingKMeans;.*.clusterer.SingleKMeans;.*.clusterer.TrackingKMeans;.*.clusterer.DetailedTrackingStats;.*.transforms.HaarWavelet;.*.clusterer.AssignmentSelector;.*.clusterer.MultiKMeans"
